...
$query_Parametros = "SELECT * FROM parametros WHERE parametros.estado = 1 ";
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Administrar Parametros de Variables a Controlar</h3>
                  ...
                  <table class="table table-bordered table-striped table-condensed">
                    <thead>
                      <tr>
                        ...
                        <th><i class="fa fa-bookmark"></i> Nombre Variable</th>
                        <th class="numeric">&nbsp;</th>
                      </tr>
                    </thead>
                    <tbody>
