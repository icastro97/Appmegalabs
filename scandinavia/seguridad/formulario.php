...
<div class="container">
    ...
    <table width="100%" border="0">
            	  <tr>
            	    ...
            	    <img src="logobig.png">
            	    <td colspan="3" align="center"><h3>Canal ético de denuncias confidencial anónimo</h3></td>
            	    </tr>
            	  <tr>
            	    <td colspan="2" align="center">&nbsp;</td>
               ...
               <form class="form" method="post" action="formulario2.php" enctype="multipart/form-data">
                    ...
                    <div class="panel-body"> 
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                            <input name="titulo"  id="titulo" type="text" required="required" style="text-transform:uppercase" class="form-control" placeholder="Titulo Reporte Confidencial"/>
                                                            </div>
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                            <input type="text" class="form-control" name="fechasiguiente" id="dateArrival1" placeholder="Seleccionar Fecha" required>
                                                            </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-1"></div>
                                ...
                                <li>(¿Cómo?)</li>
                                    ...
                                    <h5 class="text">Descripción General del Evento: </h5>
                                        <div class="col-md-3">
                                            <textarea class="area1" name="descripcion" id="" cols="80" rows="4" required="required"></textarea>
                                        </div>                            
                                    </div>
                                    ...
                                    <h5 class="text">Otros Comentarios: </h5>
                                        <div class="col-md-3">
                                            <textarea class="area" name="comentario" id="" cols="80" rows="4"></textarea>
                                        </div>                            
                                    </div>
                                    <br>
                                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input name="enviar" type="submit" id="enviar"  class="btn" value="Enviar Información" /> 
                        </div>
                    </div> 
                      </form> 
                      <br>
