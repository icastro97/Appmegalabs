...
$users = $db->getRows('system_users',array('order_by'=>'u_userid DESC')); //ojo se pone tabla a consultar
    ...
    <div class="col-12">
      <div class="table-responsive">
        <div class="panel panel-default users-content">  
            <div class="panel-heading">Usuarios Plataforma  <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["create"])) { ?> <a href="view/addEditadmin.php?op=<?php echo $_REQUEST['op']?>" class="glyphicon glyphicon-plus" ></a><?php }?></div>
            <table class="table table-striped">
                ...
                <tbody id="userData">
                    ...
                    <tr>
                        ...
                        <td><?php echo $user['u_rolecode']; ?></td>                       
                        
                        <td>
                        <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["edit"])){ ?>
                            <a href="view/addActualizaradmin.php?id=<?php echo $user['u_userid']; ?>&op=<?php echo $_REQUEST['op'];?>&cedula=<?php echo $user['cedula'];?>" class="glyphicon glyphicon-edit"></a>
                        <?php } ?>
                          <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["delete"])) { ?>    
                            <a href="view/adminAction.php?action_type=delete&id=<?php echo $user['u_userid']; ?>&op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a><?php } ?>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr><td colspan="5">Usuarios No encontrados......</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
       </div>
