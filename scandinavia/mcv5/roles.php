...
$users = $db->getRows('role',array('order_by'=>'id DESC')); //ojo se pone tabla a consultar
    ...
    <div class="col-12">
      <div class="table-responsive">
        <div class="panel panel-default users-content">  
            <div class="panel-heading">Roles  <a href="view/addEditrole.php?op=<?php echo $_REQUEST['op']?>" class="glyphicon glyphicon-plus" ></a></div>
            <table class="table table-striped">
                ...
                <tbody id="userData">
                    ...
                    <tr>
                        ...
                        <td><?php echo $user['role_rolecode']; ?></td>
                        <td><?php echo $user['role_rolename']; ?></td>
                        <td>
                         <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["edit"])) { ?>
                            <a href="view/addEditrole.php?id=<?php echo $user['id']; ?>&op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-edit"></a>
                        <?php } ?>
                          <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["delete"])) { ?>
                            <a href="view/roleAction.php?action_type=delete&id=<?php echo $user['id']; ?>&op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a><?php } ?>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr><td colspan="5">No  existen Role(s) ......</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
      </div>
