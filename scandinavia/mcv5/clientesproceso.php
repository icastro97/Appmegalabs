...
//get users from database
 $conditions['where'] = array('assignedTo'=> $filtrousuario,'visibility'=> 8,'visibility'=> 9,);
 $conditions['limit'] = '10';
...
?>
                 ...
                 <?php if(!empty($users)): $count = 0; ?>
                      ...
                      <h4><i class="fa fa-angle-right"></i> Clientes Asignados <a href="/cotizador/mcv5/clientescrm.php?tipo=9&op=<?php echo $_REQUEST['op']?>" title="Ver Todo" class="glyphicon glyphicon-play" ></a></h4>
                          <section id="unseen">
