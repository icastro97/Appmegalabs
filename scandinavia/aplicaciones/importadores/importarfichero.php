...
{    
 ...
 $folder="uploads/";
  ...
  $sql="truncate table mt_productos ";
 ...
 $db_host="localhost";
    ...
    $stmt = $conn->prepare( "INSERT INTO mt_productos (codigo, descripcion, fecha, fichero) VALUES (?, ?, ?, ?)");
    $stmt->bindParam( 1, $codigo);
    $stmt->bindParam( 2, $descripcion);
    $stmt->bindParam( 3, $fecha);
    $stmt->bindParam( 4, $fichero);
	$i= 0;
