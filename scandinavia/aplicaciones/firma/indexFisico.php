			...
			$.ajax({
				...
				success: function (response) {
					...
					let template = '';
						...
						<input type='hidden' id="tratamiento" value='${dato.tratamientoDatos}'>
						<input type='hidden' id="publicidad" value='${dato.publicidad}'>
						<input type='hidden' id="material" value='${dato.materialCientifico}'>
						<input type='hidden' id="transferencia" value='${dato.transferenciaValor}'>
          ...
          success: function (response)
          {
             ...
             else
             {
                    swal('Informacion', 'No se realizó el cruce','error').then((success)=>{
                      window.location = 'indexFisico.php';
                  });
             }
          }
        }); 
