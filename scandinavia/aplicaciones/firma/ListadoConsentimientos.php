...
$conditions['where'] = array('modulo',); 
$modulo = $db->getRows('lg_cabeza',$conditions);   
?>
       ...
       <link type="text/css" href="../../bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
        ...
        $(document).ready(function() {
				...
				var dataTable =  $('#lookup').dataTable({
					...
					"ajax":{
						url :"ajax-grid-consentimiento.php", // json datasource	
...
<div class="panel ">         
<div class="panel-heading form-control text-center" >Listado Consentimientos Informados</div> 
...
<div class="row">	
	<div class="span12">					
		<table id="lookup" class="table table-striped table-bordered" style="border: 1px solid gray;" >  
                            ...
                            <th >Habeas data</th>
                            <th >Habeas data</th>
							<input type="text" name="aprobador" id="cedula" value="<?=$cedulaSesion?>">
							</tr>
							</thead>
							<tbody>
