...
//Disparar funcion al hacer clic en el boton Ajax
    ...
    function enviar()
    {
        ...
        $.ajax({
           ...
           data:{fechaActual, nombremedico, codigom, opc,cedula,nombreP,nombreS,apellidoP,apellidoS,correo,tel, ciudad, datos3, imagen},
           success:function(response)
           {
              if(response == "bien"){
                  swal('Información','Se agrego la información','success').then((success)=>{ window.location = 'indexFisico.php';});
              }
           }
        });
    }
                                ...
                                <!--Inicio de la firma-->
                                                    ...
                                                    <form  method='post' action='indexFisico3.php' enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                            <input type="checkbox" name="datotres" id="datos3" value="Si" Onchange="check1()" checked> Transferencia de valor
                                                                <br>
