  ...
  if(isset($_POST['opcion']) )
  {
    if(!empty($tipo))
    {
      if($tipo == "fisico")
      {
        ...
        echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/indexFisico1.php';</script>";

      }
      else if ($tipo == "electronico")
      {
          echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/index1.php';</script>"; 
