...
//Disparar funcion al hacer clic en el boton Ajax
    ...
    function enviar()
    {
        ...
        $.ajax({
           ...
           data:{fechaActual, nombremedico, codigom, opc,cedula,nombreP,nombreS,apellidoP,apellidoS,correo,tel, ciudad, datos3, imagen, userid, tipoDocumento},
           success:function(response)
           {
              if(response == "bien"){
                  swal('Información','Se agrego la información','success').then((succes)=>{ window.location = 'indexFisico1.php';});
              }
              else
              {
                  swal('Información','No se agrego la información','warning').then((success)=>{ window.location = 'indexFisico1.php';});
              }
           }
        });
    }
    ...
    <div class="panel" style="border:1px solid #00AB84;">
            ...
            <div class="panel-body">  
                                ...
                                <!--Inicio de la firma-->
                                                    ...
                                                    <form  method='post' action='indexFisico3.php' enctype="multipart/form-data">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                 ...
                                                                 <input type="hidden" id="tipoDocumento" name="tipoDocumento" value="Tv">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                            <input type="hidden" name="datotres" id="datos3" value="Si" Onchange="check1()" > Transferencia de valor
                                                                <br>
