...
<div class="container">
    <div class="alert alert-success" role="alert">
      Se realizó el envío de la información correctamente!
    </div>
                                ...
                                <!--Inicio de la firma-->
                                                    ...
                                                    <form  method='post' action='firmar.php'>
                                                        ...
                                                        <div class="alert alert-light" style="background-color:#fff3cd; border-color: #ffeeba;" role="alert">
                                                            ...
                                                            <a href="documento.PNG" style='text-decoration:none;color:black;' disabled="disabled"><img src="contract.png" width="50" height="50"></a>
