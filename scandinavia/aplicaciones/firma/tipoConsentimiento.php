  ...
  if(isset($_POST['opcion']) )
  {
    if(!empty($tipo))
    {
      if($tipo == "fisico")
      {
        ...
        echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/indexFisico.php';</script>";

      }
      else if ($tipo == "electronico")
      {
          echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/index.php';</script>"; 
          
      }
      else if($tipo == "buscar")
      {
          echo "<script type='text/javascript'>window.top.location='http://appmegalabs.com/scandinavia/aplicaciones/firma/buscarConsentimiento.php';</script>"; 
      }
    }
    else 
    {
...
<div class="panel-body">    
    <div class="container" >
        ...
        <div class="panel panel-default users-content">
            <div class="panel-body">
                <div class="panel ">  
                    <div class="panel-heading text-center form-control" >Tipo de consentimiento</div> 
                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-4">
                                    <select class="form-control form-control-lg" name="tipo" id= "tipo">
                                        ...
                                        <option value="fisico">Consentimiento Fisico</option>
                                        <option value="electronico">Consentimiento Electronico</option>  
                                        <option value="buscar">Consulta Consentimiento</option>  
                                    </select>      
                                </div>  
                            </div>
                            <br />
