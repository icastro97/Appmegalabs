  ...
  if(isset($_POST['opcion']) )
  {
    if(!empty($tipo))
    {
      if($tipo == "fisico")
      {
        ...
        echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/camilo/indexFisico1.php';</script>";

      }
      else if ($tipo == "electronico")
      {
          echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/firma/camilo/index1.php';</script>"; 
                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-4">
                                    <select class="form-control form-control-lg" name="tipo" id= "tipo">
                                        ...
                                        <option value="fisico">Transferencia de valor</option>
                                        <option value="electronico">Habeas data</option>  
