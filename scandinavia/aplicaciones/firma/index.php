...
//Disparar funcion al hacer clic en el boton Ajax
			...
			$.ajax({
				...
				success: function (response) {
					...
					let template = '';
						...
						<input type='hidden' id='tratamiento' name="tratamiento" value='${dato.tratamientoDatos}'>
						<input type='hidden' id='publicidad' name="publicidad" value='${dato.publicidad}'>
						<input type='hidden' id='material' name="material" value='${dato.materialCientifico}'>
						<input type='hidden' id='transferencia' name="transferencia" value='${dato.transferenciaValor}'>
						
						<input type='button' class='btn btn-success' id='botonCruce' name="cruce" value='Cruzar' onclick="registroCruce();">
						`
					...
					else
					{
						...
						$.ajax({
						   ...
						   success:function(response)
						   {
						        let datoss = JSON.parse(response);
						        datoss.forEach(dato => {
						            if( dato.botonCruce == "0")
						            {
						                $('#botonCruce').hide();
						                $('#alertacedula').html();
						            }
    ...
    function registroCruce()
    {
        let nombrem = $('#nombremedico').val();
        let cod = $('#cod').val();
        let opcion = $('#opc').val();
        ...
        let transferencia = $('#transferencia').val();
        
        
        $.ajax({
          url:'cruce.php',
          data:{nombrem, cod, opcion, cedula, tratamiento, publicidad, material, transferencia},
          type: "POST",
          success: function (response)
          {
             if(response == "ok")
             {
                  swal('Informacion', 'Se realizo el cruce correctamente','success').then((success)=>{
             ...
             {
                    swal('Informacion', 'No se realizó el cruce','error').then((success)=>{
                                                    ...
                                                    <form  method='post' action='firmar.php'>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <input type="text" class="form-control" name="codigo" id="codigom" required placeholder="Codigo" >
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                            ...
                                                                            <input type="text" id="cedula" required name="cedula" placeholder="Cedula" class="form-control" autocomplete="off" >
                                                                             <div id="alertacedula">
                                                            ...
                                                            <div class="col-md-2">
                                                             ...
                                                             <div class="col-md-4">
                                                                            ...
                                                                            <input type="email" name="correo" required placeholder="Correo electronico" class="form-control">
                                                        ...
                                                        <div class="alert alert-light" style="background-color:#fff3cd; border-color: #ffeeba;" role="alert">
                                                            ...
                                                            <a href="documento/doc_ejemplo.pdf" style='text-decoration:none;color:black;' target="_blank"><img src="contract.png" width="50" height="50" ></a>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="dato" id="datos" value="Si" required> Tratamiento de datos personales
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="datouno" id="datos" value="Si"> Env&iacute;o de publicidad
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="datodos" id="datos" value="Si"> Env&iacute;o de material cientifico
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                            <input type="checkbox" name="datotres" id="datos" value="Si"> Transferencia de valor
                                                            </div>
                                                        ...
                                                        <div class="col-md-5">
                                                         ...
                                                         <div class="col-md-3">
                                                             <br>
                                                                       ...
                                                                       <input class="btn" style="background-color:#00AB84; color:white;" id="boton" type="submit" value="Firmar documento">
