...
function datosCompletos()
	{
	   ...
	   $.ajax({
            ...
            $("#opc").val(data.value2);
            $('#cedula').val(data.value3);
            $('#nombreP').val(data.value4);
            $('#nombreS').val(data.value5);
            $('#apellidoP').val(data.value6);
            $('#apellidoS').val(data.value7);
            $('#correo').val(data.value8);
            $('#tel').val(data.value9);
            $('#ciudad').val(data.value10);
    ...
    function enviar()
    {
        ...
        $.ajax({
           ...
           data:{fechaActual, nombremedico, codigom, opc,cedula,nombreP,nombreS,apellidoP,apellidoS,correo,tel, ciudad, dato,dato1,dato2, imagen, userid, tipoDocumento},
           success:function(response)
           {
              ...
              {
                  swal('Información','No se agrego la información','warning').then((success)=>{ window.location = 'index1.php';});
              }
           }
        });
    }
 ...
 {
     let file = document.getElementById("archivo1").files[0];
                                                    ...
                                                    <form  method='post' action='indexFisico4.php' enctype="multipart/form-data">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                 ...
                                                                 <input type="hidden" id="tipoDocumento" name="tipoDocumento" value="Ad">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <input type="text" class="form-control" name="codigos" id="codigom"  placeholder="Codigo" onchange="validacion()" onblur="datosCompletos()">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="dato" id="dato" value="Si" required > Tratamiento de datos personales
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="datouno" id="dato1" value="Si" > Env&iacute;o de publicidad
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                            <input type="checkbox" name="datodos" id="dato2" value="Si" > Env&iacute;o de material cientifico
                                                            </div>
                                                           ...
                                                           <div class="row" id="archive" >
                                                               <div class="col-md-5" style="justify-content:center;">
                                                                  ...
                                                                  <input type="checkbox" id="adjunto" onchange="adjuntos();">Adjuntar.
                                                                   ...
                                                                   <div id="arc1">
                                                                <input type="file" name="archivo1" id="archivo1" onclick="habilitarBoton();"> 
                                                                </div>
