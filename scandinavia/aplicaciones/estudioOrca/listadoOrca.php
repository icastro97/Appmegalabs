        ...
        $(document).ready(function() {
				...
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-orca.php", // json datasource			
						data:{cedula},
...
<div class="panel-heading form-control text-center" >Listado estudios</div> 
...
<div class="row">	
	...
	<div class="span12">					
		<table id="lookup" class="table table-striped table-bordered" style="border: 1px solid gray;" >  
							...
							<th width="4%" >No</th>
							<th width="6%">Tipo de estudio</th>
							<th width="5%">Fecha </th>
							<th width="5%">Nombre medico</th>
							<th width="13%">Ciudad</th>	
                            <th width="13%">Codigo Paciente</th>
                            
							<th width="5%" class="text-center"> Ver Documento </th>
							<input type="hidden" name="cedula" id="cedula" value="<?=$cedulaSesion?>">
							</tr>
							</thead>
							<tbody>
