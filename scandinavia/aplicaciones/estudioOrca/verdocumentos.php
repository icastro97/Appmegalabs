                                ...
                                <div class="panel-heading text-center form-control" >Otros hallazgos</div>
                                            ...
                                            <div class="panel-body"> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                    <ul>
                                                        <li ><h5>¿Alguna OTRA ENFERMEDAD o FACTOR DE RIESGO que tenga el paciente  (DIFERENTE A LO CONTEMPLADO EN EL FORMATO <strong>CUESTIONARIO IMPRESO</strong>)?</h5></li>
                                                    </ul>
                                                    </div>            
                                                    <div class="col-md-1"></div>
                                                    <div class="col-md-2">
