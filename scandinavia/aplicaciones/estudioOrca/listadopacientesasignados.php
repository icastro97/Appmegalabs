        ...
        $(document).ready(function() {
				...
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-pacientes.php", // json datasource			
...
<div class="panel-heading form-control text-center" >Listado Pacientes</div> 
...
<div class="row">	
	...
	<div class="span12">					
		<table id="lookup" class="table table-striped table-bordered" style="border: 1px solid gray;" >  
							...
							<th width="5%">Codigo Paciente</th>
							<th width="5%">Cedula Medico </th>
							<th width="13%">Nombre medico</th>
