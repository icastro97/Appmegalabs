...
// getting total number records without any search
	...
	$sql = "SELECT `id_formularioc`, `estudio`, `fechaActual`, `nombreMedico`, `ciudad`, `codigoPaciente`,archivo FROM `formulariochaco` where cedulaMedico = ". $cedula;
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT `id_formularioc`, `estudio`, `fechaActual`, `nombreMedico`, `ciudad`, `codigoPaciente`,archivo FROM `formulariochaco` where cedulaMedico LIKE '%".$requestData['search']['value']."%'";
