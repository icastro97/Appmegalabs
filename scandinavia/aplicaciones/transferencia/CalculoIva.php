...
<h2 align = "center">Transferencia de Valor</h2>
   ...
   <form id="my-form" method="post"  name="insertregistro" enctype="multipart/form-data">
	...
	<div class="panel" style="border:1px solid #00AB84;" id="panelg">            
			...
			<div class="row">
					...
					<div class="col-md-2">
									...
									<input name="identificacion"  id="identificacion" onKeyUp="empleado(1)"  onBlur="empleado2(1)" type="text" required="required" class="form-control"   placeholder="Identificaci贸n" value="<?php echo $users[0]['identificacion']; ?>"  disabled/>
									</div>
	...
	<div class="panel-heading text-center form-control" >Alta informaci贸n</div>                    
			<td >&nbsp;</td>
			<td >&nbsp;</td>         
                  ...
                  <td><div class="col-md-5">
								...
								<div class="col-md-2">
                                  ...
                                  <div class="input-group">
                                   ...
                                   <input id="valor1" name="valorSinImpuestos[]" class="monto form-control currency" onclick="sumar()" onchange="sumar()"  onkeyup="promedio();" type="text" required/>
                                  ...
                                  <div class="input-group">
                                   <span class="input-group-addon">$</span>                                                                    
                                   <input id="valor2" name="valorImpuesto[]" class="monto form-control currency" onclick="sumar()" onkeyup="promedioIVA()" onchange="sumar()" type="text" required/>
								...
								<div id="valoresgg">
			    			      <label for="ex2">Impuesto al consumo:</label>
			    			      	 ...
			    			      	 <div class="input-group" >
                                   <span class="input-group-addon">$</span>                                                                    
                                   <input id="valor3" name="valorIca[]" class="monto form-control currency" onclick="sumar()" onkeyup="exento()" onchange="sumar()" type="number"/>
									</div>
									</div>										
...
<div class="row">
				...
				<div class="col-md-3">
					<input name="input" type="submit" id="buttonsave" class="btn input" style="background-color:#00AB84; color:white;" value="A帽adir"/> 
            ...
            <p>&nbsp;</p>
            <button onClick="resultao()">oehreui</button>
...
let promediod = 0;
    function promedio(){
        let valorbase = $('#valor1').val();
        let res = +valorbase * 0.08;
        this.promediob = res;
        console.log("Promedio: "+this.promediob);
    }
    
    function promedioIVA(){
        let valorIVA = $('#valor2').val();
        let promedioa = +valorIVA * 0.16;
        this.promedioc = promedioa;
        console.log(this.promedioc);
    }
    function exento(){
        let valorEx = $('#valor3').val();
        let resultado = +valorEx * 0.19;
        this.promediod = resultado;
        console.log(this.promediod);
    }
    function resultao(){
         let sumar = this.promediob + this.promedioc + this.promediod;
         console.log(sumar);
    }
</script>
