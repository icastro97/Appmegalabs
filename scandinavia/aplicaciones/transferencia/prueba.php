      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
									...
									<td><?php echo $user['id_transferencia']; ?></td>
									 ...
									 if ($user['estado'] == "ACEPTADO" || $user['estado'] == "APR") {
                                        ...
                                        else       
                                        {
        										...
        										echo "<td align='center'> <a href='mostrarAsistentes.php?documento=$identificadorDet' class='btn' style='background-color:#00AB84;' target='_blank'><i class='menu-icon glyphicon glyphicon-search' style='color:white;'></i></a> </td>";
		...
		<?php
		    ...
		    $sql2 = "SELECT sum(valor) as valor FROM codigosSi where id_factura = '$cabeza' and tipo = 'SI' ";
...
if($user['aprobador'] == $user_id && $user['estado'] == "ACEPTADO" )
{
	...
	<div class="container">
	    ...
	    ?>
	    <h6>Pago especial <img src="https://image.flaticon.com/icons/svg/291/291201.svg" width="20px"> </h6>
	    <?php
	       }
	       else
	       {
	    ...
	    <h6>Factura Deposito <img src="https://image.flaticon.com/icons/svg/291/291201.svg" width="20px"></h6>
	    ...
	    <h6>No Inversion Comercial <img src="https://image.flaticon.com/icons/svg/291/291201.svg" width="20px"></h6>
