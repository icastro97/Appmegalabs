												...
												<table class="table">
                                                  <thead class="thead-dark">
                                                    <tr>
                                                      ...
                                                      <th scope="col">Novedad Contabilidad</th>
                                                      <th scope="col">Observacion</th>
                                                      <th scope="col">Obs. Contabilidad</th>
                                                      <th scope="col">Pago Especial</th>
                                                      <th scope="col">Observacion Aceptado</th>
                                                      <th scope="col">Observacion Revision</th>
                                                      <th scope="col">Observacion G</th>
                                                    </tr>
                                                  </thead>
                                                  <tbody id="columna">
