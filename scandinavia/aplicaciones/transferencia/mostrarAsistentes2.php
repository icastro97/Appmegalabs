 ...
 <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <a class="glyphicon glyphicon-circle-arrow-left" target="_blank"  onclick="window.close();"  style="color:#337ab7;cursor:pointer;"></a> Regresar 
         <br>
    <div class="row">
         <div class="col-md-6">
    ...
    <tr>
        ...
        ?> 
           <tr>
                ...
                <td>
                    <?php
                    if(empty($user['consentimiento']))
                    {
                        echo "No cuenta con consentimiento"; 
                    }
                    else
                    {
                        
                        echo $user['consentimiento'];
                    }
                    ?>
                </td>
