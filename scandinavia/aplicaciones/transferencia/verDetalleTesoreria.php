 ...
 <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
             <a href="https://appmegalabs.com/scandinavia/aplicaciones/transferencia/listados/tesoreria/index.php?op=Pago tesoreria" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
             <br>
    <div class="row">
        <div class="col">
...
<form>
   ...
   <div class="col">
            ...
            ?>
            <button class="btn btn-danger btn-sm" style="margin-left:1000px" onClick="devolverFactura(<?php echo $user['id_transferencia']; ?>)">Devolver Factura</button> 
            <br>
            <br>
