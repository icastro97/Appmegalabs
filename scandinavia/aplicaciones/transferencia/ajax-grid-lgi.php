...
$sql1 = "SELECT * FROM transferencia_val where id_transferencia = " . $_POST['varidentificadounico'];
$query33 = mysqli_query($mysqli,$sql1);
// var_dump(mysqli_error($mysqli));
while($row = mysqli_fetch_assoc($query33))
{
	$id_cabeza =  $row['id_transferencia'];
}

$sqls = "SELECT * FROM transferencia_val where id_transferencia = " . $_POST['varidentificadounico'];
...
$sql = "SELECT * FROM transferencia_val where id_transferencia = " . $_POST['varidentificadounico'];
...
if($totalData > 0){
$sql = "select a.id_transferencia, a.moneda,sum(a.valor) as suma from transferencia_val a  where id_transferencia = " . $_POST['varidentificadounico'] . " group by a.id_transferencia, a.moneda	";
...
$sql20= "select a.factura,a.nit ,a.fichero as name, a.tipo as type, a.id_transferencia as transferencia, b.ico from transferencia_val a inner join rc_mime b on a.tipo = b.type where a.id_transferencia =   " . $_POST['varidentificadounico'];
...
echo "	<tr>";
	echo " 		<td>".$row_Transacciones['id_transferencia']."</td>";
	...
	if($row_Transacciones['tipo'] == "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
	{
		...
		echo "<img src='/scandinavia/assets/images/ico/ico_word' width='20' height='20' />"; 
	}
	else if($row_Transacciones['tipo'] == "image/png")
	{
		echo "<a href=\"uploads/" . $row_Transacciones['fichero'] . " \"target=\"\_blank\">";
		echo "<img src='/scandinavia/assets/images/ico/ico_png' width='20' height='20' />"; 
		
	}  
	else if ($row_Transacciones['tipo'] == "application/pdf")
	{
		echo "<a href=\"uploads/" . $row_Transacciones['fichero'] . " \"target=\"\_blank\">";
		echo "<img src='/scandinavia/assets/images/ico/ico_pdf' width='20' height='20' />";                   
	}
	else if($row_Transacciones['tipo'] == "image/jpg" or $row_Transacciones['tipo'] == "image/jpeg")
	{
		echo "<a href=\"uploads/" . $row_Transacciones['fichero'] . " \"target=\"\_blank\">";
		echo "<img src='/scandinavia/assets/images/ico/ico_jpg' width='20' height='20' />"; 
	}	
	...
	eliminarsolicitud2('".$row_Transacciones['id']."' , '".$row_Transacciones['factura']."')\"></td>";
...
if($row_Transacciones['tipoCodigo'] == "SI")
{
	...
	<?php
		...
		?> 	
		<?php 
		$usuario = $row_Transacciones['id_transferencia'];
