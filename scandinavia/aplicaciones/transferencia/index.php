 ...
 <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <a href="https://appmegalabs.com/scandinavia/default1.php?group=Facturas" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
         <br>
				 <br> 
				 <div class="row">
   ...
   <form id="my-form" method="post"  name="insertregistro" enctype="multipart/form-data">
	...
	<div class="col-md-3">
			...
			<select name="opciones" id="opciones" required onchange="esconde()" >
			    ...
			    <option value="Cobro">Cuentas de cobro</option>
			    <option value="Importacion">Factura Importacion</option>
			</select>
	
			</div>
			<div class="col-md-6"></div>
			<div class="col-md-2">
	<input  type="text"  class="form-control" id="cambio" placeholder="Radicado" name="radicado" onblur="validaRadicado()" required  />
	</div>
        </div>	    
	...
	<div class="panel" style="border:1px solid #00AB84;" id="panelg">            
			...
			<div class="row">
					...
					<div class="col-md-2">
									...
									<input name="identificacion"  id="identificacion" onKeyUp="empleado(1)"  onBlur="empleado2(1)" type="text" required="required" class="form-control"   placeholder="Identificaci®Æn" value="<?php echo $users[0]['identificacion']; ?>"  disabled/>
									</div>
	...
	<div class="panel-heading text-center form-control" >Alta informaci√≥n</div>                    
			<td >&nbsp;</td>
			<td >&nbsp;</td>         
			     <div id="validarF"></div>
              <div class="row">
			  <div class="col-md-1">
					...
					<div class="col-md-2">
                                  ...
                                  <div class="input-group">			    			     
			    			      <input name="nit[]" class="form-control" id="nit1" onKeyUp="valida(1)" onblur="validacionFact();"  onchange="valida(1)"  required="required" type="text" placeholder="NIT">
		    					  </div>
					</div>   
					<div class="col-md-3">
			    			      <label for="ex2">Establecimiento</label>
                                  <div class="input-group">			    			     
			    			      <input name="establecimiento[]" class="form-control input-sm" id="establecimiento1" style="text-transform:uppercase" onclick="llenaNombre()"  type="text" placeholder="Establecimiento" required>
		    			        </div>
					</div> 
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                                  ...
                                  <div class="input-group">			    			     
			    			      <input name="factura[]" class="form-control input-sm" id="factura1" onchange="validacionFact();" onblur="validacionFact();"  required="required" type="text"  placeholder="Factura">
		    			          </div>
					</div>
...
<div class="row">
				...
				<div class="col-md-3">
				    <input id="vas" type="hidden">
				    <input name="useridl" type="hidden" id="usuario" value="<?=$_SESSION['id'];?>" /> 
					<input name="input" type="submit" id="buttonsave" class="btn input" style="background-color:#00AB84; color:white;" value="A√±adir"/><br><br>
					<button name="input" id="traeF" class="btn input" style="background-color:#00AB84; color:white;" onclick="prs123()"><i class="glyphicon glyphicon-repeat">
