...
<form>
   ...
   <div class="col">
            ...
            <a style="margin-left:400px;">    
			<img src="https://image.flaticon.com/icons/svg/204/204276.svg" width="50px" height="50px" onClick="enviaPago(<?php echo $user['id_transferencia']; ?>)">
            </a>
            <br>
            <label style="margin-left:400px;">Enviar a pago</label>
                    
			<a >        
			<img style="margin-top:-70px; margin-left:90px;" src="https://image.flaticon.com/icons/svg/138/138296.svg" width="50px" height="50px" onClick="enviaCruce(<?php echo $user['id_transferencia']; ?>)">
            </a><br>
                                    <label style="margin-left:570px;margin-top:-25px;">Enviar a cruce</label>

        
        
            <button class="btn btn-danger btn-sm" style="margin-left:1025px; margin-top:-40px;" onClick="devolverFactura(<?php echo $user['id_transferencia']; ?>)">Devolver Factura</button> 
