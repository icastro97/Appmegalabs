...
<h2 align = "center">Transferencia de Valor</h2>
   ...
   <form id="my-form" method="post"  name="insertregistro" enctype="multipart/form-data">
	...
	<div class="col-md-3">
			...
			<input type="text" name "pri" id="pruebass" onKeyup="pruebas()"  class="form-control" placeholder="Codigo QR"><br>
			  ...
			  <div class="col-md-1">
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                                  ...
                                  <div class="input-group">			    			     
			    			      <input name="factura[]" class="form-control input-sm" id="factura1"  required="required" type="text" onchange="validacionFact()" placeholder="Factura">
		    			          </div>
					</div>
...
<div class="row">
            ...
            <button onClick="prepara_escaner()" id="prepara">preparar</button>
<button onClick="escanear()" id="escanea">Escanear</button>
