...
$sql = "UPDATE transferencia_val set estado = 'NO ACEPTO', observacionG = '$obser', ultimoCambioEstado = NOW() WHERE id_transferencia = '$id'";
$ejecutar = mysqli_query($mysqli, $sql);
$consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$id','$user','NO ACEPTO',NOW(),'$obser')";
...
$asunto = "Factura ".$id." ha sido rechazada";
$mail->Subject = utf8_decode($asunto); // Este es el titulo del email.
$body = " Estimado/a  , <br><br>
El estado de la factura $id es <strong>RECHAZADA</strong>
...
if ($ejecutar == TRUE) {
    $consulta = "INSERT INTO Historico_facturas (id_factura, usuario, nuevo_estado, fecha_cambio) VALUES ('$id', '$user', 'NO ACEPTO', NOW())";
