...
if(isset($_POST['adjunto']))
{
    ...
    require_once('funcionesAsistentes.php');
           ...
           if(file_exists($archivoGuardado))
            {
                            ...
                            while ($datos = fgetcsv($fp,0,";"))
                            {
                                        ...
                                        if($rows > 1)
                                        {
                                            ...
                                            $resultado = insertarDatos($datos[0], $datos[1],$datos[2],$id, $datos[3]);
        ...
        <div class="row" id="row">
            <div class="col-6 col-md-4"></div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="panel-heading text-center form-control"  id="panel" >Importador Asistentes</div>
                        </div>
