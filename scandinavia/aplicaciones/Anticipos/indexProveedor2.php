...
if($users > 0){
    $sql = "select consecutivo, moneda,sum(monto) as sumas from anticipo  where consecutivo = $sid  group by consecutivo, moneda	";
            ...
            $(document).ready(function() {
                ...
                $("#my-form").submit(function(e) {
                    ...
                    $.ajax( {
                        ...
                        url: "guardarajaxproveedores2.php",
                        method: "post",
                        //data: $("form").serialize(),
		...
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4) {
				...
				divResultado.innerHTML = ajax.responseText
				 $("#resultado1").load('ajax-grid-lgi.php',{'varidentificadounico': consecutivo});
			}
		}
...
$(document).ready(function(){
    $("#inversioncom1").change(function(){
        ...
        if($("#texto").length === 0){
            ...
            $("#info").append("<input class='form-control' name='evento' id='texto' type='text' placeholder='Nombre'>");
            $("#info2").append("<label id='inver'>C. inversión<label>");
            $("#info2").append("<input class='form-control' name='cinversion' id='texto1' type='text'placeholder='C.inversión'>");
            $("#info3").append("<label for='ex2' id='fec'>Fecha Inicial</label>");
            $("#info3").append("<input type='date' class='form-control inputstl' name='fechaini' id='fechaini'>");
            $("#info4").append("<label for='ex2' id='fech'>Fecha Final</label>");
            $("#info4").append("<input type='date' class='form-control inputstl' name='fechafin' id='fechafin'>");
            $("#info5").append("<label for='ex2' id='des'>Descripcion</label>");
            $("#info5").append("<textarea name='descripcion' class='form-control input-sm' id='descripcion1'  style='text-transform:uppercase' rows='3' cols='45'></textarea>");
        }    	
        }else{
            $("#texto").remove(); 
            $("#texto1").remove(); 
...
<div class="row">
	...
	<div class="col-md-3"><a href="baja2.php?dato=<?php echo $users[0]['consecutivo']; ?>" class="btn btn-danger" >Dar baja </a></div>
 ...
 <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <a href="http://appscandinavia.com/scandinavia/aplicaciones/Anticipos/Proveedor2.php?tp=Proveedor" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
         <br>
         <br> 
...
<div class="container">
    ...
    <table width="100%" border="0">
            	  <tr>
            	    ...
            	    <td colspan="3" align="center"><h3>Solicitud de Anticipo Proveedor</h3></td>
            	    </tr>
            	  <tr>
            	    <td colspan="2" align="center">&nbsp;</td>
   ...
   <div class="panel" style="border:1px solid #00AB84;">
                    ...
                    <div class="panel-body"> 
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                        			    			        ...
                                        			    			        <input name="nit[]" class="form-control" id="nit1" onKeyUp="valida(1)"  required="required" type="text" value="<?php echo $users[0]['identificacion']?>" readonly="readonly">
                                                                            </div>
                                                             ...
                                                             <div class="col-md-3">
                                        			    			        ...
                                        			    			        <input name="establecimiento[]" class="form-control input-sm" id="establecimiento1" style="text-transform:uppercase" required="required" type="text" value="<?php echo $users[0]['nombre']?>" readonly="readonly">
                                                                            </div>
                                                            ...
                                                            <div class="col-md-3 ">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="row">
                                                			    			        <div class="col-md-2">
                                                                                        <input type="checkbox" name="efectivo" id="efectivo1"  onClick="disableDos(this)">
                                                                                     </div>   
                                                                                     <h5 class="texto">Efectivo</h5>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-2">
                                                                                        <input type="checkbox" name="transferencia" id="transferencia1"  onClick="disableUno(this)">
                                                                                    </div>
                                                                                    <h5 class="texto"> Transferencia</h5>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-2">
                                                                                        <input type="checkbox" name="cheque" id="cheque1"  onClick="disableTres(this)"> 
                                                                                    </div>
                                                                                    <h5 class="texto">Cheque de Gerencia</h5>
                                                                                </div>
                                                            ...
                                                            <div class="col-md-3 ">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="row">
                                                			    			        <div class="col-md-2">
                                                                                        <input type="checkbox" name="inversioncom" id="inversioncom1" onClick="deshabilitarOtros(this)">
                                                                                     </div>   
                                                                                     <h5 class="texto"> Inversión Comercial</h5>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-md-2">
                                                                                        <input type="checkbox" name="otros" id="otros1" onClick="deshabilitarInversion(this)">
                                                                                    </div>
	...
	<div class="panel" style="border:1px solid #00AB84;" >            
			...
			<div class="row">
			<div class="col-md-4" id=""></div>
			<div class="col-md-6" id="apro2"><div id='checkaprobador'><h5>Cambiar aprobador: <input type='hidden'><input type='checkbox' id='cambioapr' name='cambioaprobador' onchange='check1()'></h5></div></div>			
            </div>
            <br>
			<div class="row">
            <div class="col-md-4" id=""></div>	
            ...
            <input type="hidden" name="tp" id="tp" value="Proveedor">
                ...
                <td><div id="resultadotemporal">
								...
								<tbody id="userData2">
                                        ...
                                        <td><?php echo $user['consecutivo']; ?></td>
                                            ...
                                            <td ><a class="btn btn-danger" href="eliminaproveedor2.php?documento=<?=$user['id_anticipo']?>&amp;consecutivo=<?=$user['consecutivo']?>&amp;op=LISTADO ANTICIPOS">Eliminar</a>
                                ...
                                <form action="finalizadocPro.php" method="post" enctype="multipart/form-data">
                                <?php
                                ...
                                while( $row_Transacciones2=mysqli_fetch_array($query2) ) {  // preparing an array
                                    ...
                                    if($total >= 5000000 && $user['identificacion'] != "830000167-2")
                                    {
                                        
                                        echo "<label for='ex2' id='ar'>Adjuntar póliza</label>";
                                        echo "<input name='file' id='file' type='file' >";		
                                        echo "<br>";
                                        echo "<br>";		
                                        ?>
                                        <div class="col-md-1">
                                        <input type="hidden" value=<?=$user['consecutivo']?> name="documento">    
                                        <button disabled="disabled" type="submit" class="btn btn-success" style="color: white;">Finalizar Documento</button>      
                                        </div>
                                        <?php
                                    ...
                                    else
                                    {
                                        ...
                                        <div class="col-md-1">
                                            <a class="btn" style="background-color:#00AB84; color:white;" href="finalizadocPro2.php?op=LISTADO ANTICIPOS&amp;documento=<?=$user['consecutivo']?>" >Finalizar Documento</a>       
                                        </div>
