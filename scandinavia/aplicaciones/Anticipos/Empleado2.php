...
$condition['where'] = array('identificacion'=> $cedulaSesion,'group by identificacion'); 
$usuario = $db->getRows('anticipo',$condition);
?>
...
<html lang="en">
        ...
        $(document).ready(function() {
				...
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-e.php", // json datasource
						data:{identificacion},
 ...
 <a href="http://appmegalabs.com/scandinavia/aplicaciones/Anticipos/tipoAnticiposAbiertos.php?op=Anticipos%20abiertos" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
         <br>
         <br>
<div class="panel" style="border:1px solid #00AB84;"> 

<div class="panel-heading form-control text-center" >Anticipos Empleado pendientes por finalizar</div> 
...
<div class="row">	
	...
	<div class="span12">					
		<table id="lookup" class="table table-striped table-bordered" style="border: 1px solid gray;" >  
							...
							<input type="hidden" name="identificacion" id="identificacion" value="<?=$usuario[0]['identificacion']?>">
							</tr>
							</thead>
							<tbody>
