...
<a href="http://appmegalabs.com/scandinavia/aplicaciones/Anticipos/Compras.php?op=Compras" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
         <br>
         <br>                  
...
?>    
        ...
        $userids = $detalle[0]['userid'];
                    ...
                    <?php
                    if ($cabeza[0]['confirmacionCompras'] == false && $cabeza[0]['monto'] <= $montoAutorizado ) {
...
<div class='btn-group'>
            ...
            <div class='col-md-5' >
              ...
              <div class='col-md-3' >               
              <input type='hidden' value=' $parametro' id='consecutivo' >
              <input type='hidden' value='menor' id='tipo' >   
              <input type='button' class='btn btn-success'  id='boton' value='Enviar confirmación.' onclick='validacion()'>
...
<div class='btn-group'>
            ...
            <div class='col-md-5' >
              ...
              <div class='col-md-3' >               
              <input type='hidden' value='$parametro' id='consecutivo' >   
              <input type='hidden' value='mayor' id='tipo' >   
              <input type='button' class='btn btn-success'  id='boton' value='Enviar confirmación.' onclick='validacion()'>
            ...
            ";
                    ...
                    if($cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" &&  $cabeza[0]['confirmacionGerencia'] == ""  && $cabeza[0]['monto'] > $montoAutorizado )
                    { 
                    ...
                    if($cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" &&  $cabeza[0]['confirmacionCompras'] == "true"  && $cabeza[0]['monto'] <= $montoAutorizado )
                    { 
                    ...
                    if($cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" &&  $cabeza[0]['confirmacionGerencia'] == "true"  && $cabeza[0]['monto'] > $montoAutorizado )
                    { 
                      echo "<div class='alert alert-warning'><h4>Anticipo en Aprobador</h4></div>";
              ...
              if(response == "Actualizado ")
              {
                  ...
                  swal("Rechazo anticipo", {
								icon: "success",
									...
									window.location = 'https://appmegalabs.com/scandinavia/aplicaciones/Anticipos/Listados/Compras/index.php?op=Compras';
								});
