   ...
   <td width="20%" class="formato" colspan="5"></td><td >&nbsp;</td>   <td class="formato" colspan="5"></td>
            ...
            <tbody id="userData2">
              ...
              <td>&nbsp;</td>
                ...
                {
                  if($user['archivo'] != "img_"  || $user['archivo'] != " ")
                  {
                       ?>
...
?>    
        ...
        if($cabeza[0]['tipo'] == "Empleado" && $cedulaAnticipo != $cedulaLogueada && $cabeza[0]['estado'] == "1")//Aprobacion anticipo de empleado
        {
        ...
        else if($cabeza[0]['tipo'] == "Proveedor" && $cabeza[0]['estado'] == "1" && $cabeza[0]['confirmacionCompras'] == "")
        {
             echo "<div class='alert alert-danger'><h4 align='center'>Anticipo en Compras</h4></div>";
        }
        else if($sesionLogueada == $userids && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true"  &&  $cabeza[0]['monto'] <= $montoAutorizado )
        {
          
            echo "<div class='alert alert-warning'><h4 align='center'>Anticipo en Aprobador</h4></div>";
          
          
        }
        else if($cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" && $cabeza[0]['confirmacionGerencia'] == ""  && $cabeza[0]['monto'] > $montoAutorizado )
        {
          
            echo "<div class='alert alert-danger'><h4 align='center'>Anticipo en Gerencia</h4></div>";
            
        }
        else if($sesionLogueada == $userids  && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" &&  $cabeza[0]['confirmacionGerencia'] == "true"  && $cabeza[0]['monto'] > $montoAutorizado )
        {
            
            echo "<div class='alert alert-warning'><h4 align='center'>Anticipo en Aprobador</h4></div>";
            
        }
         else if($cabeza[0]['tipo'] == "Proveedor" && $sesionLogueada != $userids && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" && $cabeza[0]['confirmacionGerencia'] == "true" ) //Aprobacion cuando compras y gerencia ya confirman el anticipo
        {
            ?>
            <table width="70%" border="0" class="table table-striped">
              <tr>
        ...
        else if($cabeza[0]['tipo'] == "Proveedor" && $sesionLogueada != $userids && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" && $cabeza[0]['confirmacionGerencia'] == "" && $cabeza[0]['monto'] <= $montoAutorizado)
        {
        ?>
            <table width="70%" border="0" class="table table-striped">
              <tr>
        ...
        else if($cabeza[0]['tipo'] == "Proveedor" && $sesionLogueada != $userids && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" && $cabeza[0]['confirmacionGerencia'] == "true" && $cabeza[0]['monto'] > $montoAutorizado)
        {
        ?>
            <table width="70%" border="0" class="table table-striped">
              <tr>
        ...
        <?php    
         ...
         else if($cabeza[0]['estado'] == 'APR' || $cabeza[0]['estado'] == 'APRC')
        {
                echo " <div class='alert alert-success'><h4 align='center'>Anticipo aprobado.</h4></div>   "; 
        }
        else if( $cabeza[0]['estado'] == 'REC' || $cabeza[0]['estado'] == 'RECC')
        {
                echo " <div class='alert alert-danger'><h4 align='center'>Anticipo rechazado.</h4></div>   "; 
        }
        else if( $cabeza[0]['estado'] == 'RCOM')
        {
                echo " <div class='alert alert-danger'><h4 align='center'>Anticipo rechazado por compras.</h4></div>   "; 
        }
        else if( $cabeza[0]['estado'] == 'RGER')
        {
                echo " <div class='alert alert-danger'><h4 align='center'>Anticipo rechazado por gerencia.</h4></div>   "; 
        }
        ?>
   ...
   ?>          
            ...
            <input type="hidden" name="tipo" id="tipo" value="<?=$cabeza[0]['tipo']?>">
