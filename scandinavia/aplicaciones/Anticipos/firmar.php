...
$conditions['where'] = array('consecutivo'=> $consecutivo,); 
                                ...
                                <!--Inicio de la firma-->
                                                    ...
                                                    <form id='formCanvas' method='post' action='firmar2.php' ENCTYPE='multipart/form-data'>
                                                            ...
                                                            <div class="col-md-3">
                                        			    			        ...
                                        			    			        <input name="cedula"  id="identificacion" type="text"  readonly="readonly"  class="form-control"    value="<?php echo $users[0]['identificacion']?>"/>
                                                                            </div>
