...
$anticipo = [];
$sql = "SELECT T1.consecutivo, T1.tipo, T1.fechaActual, T1.identificacion, T1.nombre, T1.estado FROM anticipo T1 INNER JOIN system_users T2 WHERE T1.estado = '0' and T1.userid = ".$user." AND tipo='Empleado' group by T1.consecutivo";
