...
$sql="UPDATE anticipo SET estado = '$estadoscartera', observacionAprobador = '$observaciones', fechaaprobador = NOW() Where consecutivo = ". $recibo ; 
...
while($row = mysqli_fetch_array($result))
{
    ...
    $nombre = $row['full_name'];
        ...
        if($estadoscartera == "APR")
        {
                ...
                $mail->AddAddress("jhuertas@scandinavia.com.co"); // Esta es la dirección a donde enviamos
                ...
                $asunto = "Anticipo ".$recibo." ha sido aprobada";
        ...
        $mail = new PHPMailer();
                ...
                $mail->IsHTML(true); // El correo se envía como HTML
                $asunto = "Anticipo ".$recibo." ha sido rechazada";
                $mail->Subject = utf8_decode($asunto); // Este es el titulo del email.
                $body = " Estimado/a  $nombre, <br><br>
                El estado del Anticipo $recibo es <strong>$estadoscartera</strong>
