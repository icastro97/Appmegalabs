...
$consulta = "SELECT nit, userid FROM anticipo WHERE consecutivo = ".$filtro ;
...
$query_Cabeza  	= "update anticipo set estado = 1 where consecutivo =  " . $filtro;
...
//header('Location: /scandinavia/aplicaciones/Anticipos/Listados/Proveedores/index.php');				 
