...
?>    
        ...
        {
             echo "<div class='alert alert-danger'><h4>Anticipo en Compras</h4></div>";
        }
        else if($sesionLogueada == $userids && $cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true"  &&  $cabeza[0]['monto'] <= $montoAutorizado )
        {
          
            echo "<div class='alert alert-danger'><h4>Anticipo en Aprobador</h4></div>";
        ...
        else if($cabeza[0]['estado'] == '1' && $cabeza[0]['confirmacionCompras'] == "true" && $cabeza[0]['confirmacionGerencia'] == ""  && $cabeza[0]['monto'] > $montoAutorizado )
        {
            ...
            echo "<div class='alert alert-danger'><h4>Anticipo en Gerencia</h4></div>";
        ...
        {
                echo " <div class='alert alert-success'><h4>Anticipo aprobado.</h4></div>   "; 
        }
        else if( $cabeza[0]['estado'] == 'REC' || $cabeza[0]['estado'] == 'RECC')
        {
                echo " <div class='alert alert-danger'><h4>Anticipo rechazado.</h4></div>   "; 
        }
