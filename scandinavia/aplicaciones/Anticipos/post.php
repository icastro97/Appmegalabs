...
{
   //echo "Mayor";
        $consulta = "UPDATE anticipo  SET confirmacionCompras='$check' WHERE consecutivo =".$consecutivo;  
        ...
        if($var)
        {
                    ...
                    $mail->AddAddress("Mladino@scandinavia.com.co"); // Esta es la dirección a donde enviamos
                    
                    
                    $mail->IsHTML(true); // El correo se envía como HTML
                    $asunto = "Anticipo ".$consecutivo." ha sido aceptado por compras";
                    $mail->Subject = utf8_decode($asunto); // Este es el titulo del email.
                    $body = " Estimado/a  MARTIN LADINO CLAVIJO, <br><br>
                    El anticipo esta disponible para su respectiva aceptación.
...
else if($tipo == "menor")
{
    //echo "Menor";
        ...
        if($var)
        {
                    ...
                    El anticipo esta disponible para su respectiva aprobación.
                    <br><br>El enlace para acceder a la plataforma es: <a href='appmegalabs.com'>appmegalabs.com</a>
                    <br><br><br>Cordial saludo,
                    <br><br>Sistema de notificaciones Portal de aplicaciones Megalabs.
                    <br><br><img width='180' height='70' src='https://appmegalabs.com/scandinavia/assets/img/Megalabs_Logo.png'>";
