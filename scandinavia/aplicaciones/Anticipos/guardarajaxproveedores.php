...
$aprobador = $_POST['cedulaSesion'];

$fechadesembolso = $_POST['fechadesembolso'];
$check = $_POST['cambioaprobador'];
$confirmacionCompras = $_POST['confirmacionCompras'];
$confirmacionGerencia = $_POST['confirmacionGerencia'];
