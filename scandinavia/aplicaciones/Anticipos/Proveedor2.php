...
if(!isset($_SESSION["session_username"])) {	
  header("location:../../seguridad/index.php");
	...
	$condition['where'] = array('userid'=> $sesion,'group by userid'); 
        ...
        $(document).ready(function() {
				...
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-p.php", // json datasource
						data:{id},
...
<div class="panel-heading form-control text-center" >Anticipos Proveedor pendientes por finalizar</div> 
...
<div class="row">	
	...
	<div class="span12">					
		<table id="lookup" class="table table-striped table-bordered" style="border: 1px solid gray;" >  
							...
							<input type="hidden" name="id" id="id" value="<?=$usuario[0]['userid']?>">
							</tr>
							</thead>
							<tbody>
