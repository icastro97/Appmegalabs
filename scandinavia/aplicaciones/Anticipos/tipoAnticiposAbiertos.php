...
$tipo = $_POST['tipo'];
  ...
  if(isset($_POST['opcion']) )
  {
    if(!empty($tipo))
    {
      if($tipo == "Anticipos abiertos empleados")
      {
      ...
      else if ($tipo == "Anticipos abiertos proveedores")
      {
          echo "<script type='text/javascript'>window.top.location='https://appmegalabs.com/scandinavia/aplicaciones/Anticipos/Listados/Proveedores/index.php';</script>";
...
<div class="panel-body">    
    <div class="container" >
        ...
        <div class="panel panel-default users-content">
            <div class="panel-body">
                <div class="panel">  
                    <div class="panel-heading text-center form-control" >Anticipos abiertos</div> 
                ...
                <form action="" method="post">    
                            <div class="row">  
                                ...
                                <div class="col-md-4">
                                    <select class="form-control form-control-lg" name="tipo" id= "tipo">
                                        ...
                                        <option value="Anticipos abiertos empleados">Anticipos abiertos empleados</option>
                                        <option value="Anticipos abiertos proveedores">Anticipos abiertos proveedores</option>  
                                    </select>      
                                </div>  
                            </div>
                            <br />
                            <div class="form-group" >
                                <div class="col-lg-12 control-label" align="center">
                                    <button class="btn" style="color:white; background-color:#00AB84;" name="opcion" type="submit">Enviar</button> 
                                </div>
                            </div>                       
                </form>               
            </div>    
