...
$consulta="UPDATE anticipo SET estado = 'RCOM', observacionContabilidad='$descripcion' WHERE consecutivo =".$id_anticipo;
...
$asunto = "Anticipo ".$id_anticipo." ha sido rechazada por compras";
$mail->Subject = utf8_decode($asunto); // Este es el titulo del email.
$body = " Estimado/a  $nombre, <br><br>
El estado del Anticipo $id_anticipo es <strong> RCOM </strong>
<br>
