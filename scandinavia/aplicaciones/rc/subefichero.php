...
<script src="../formulario1/bootstrap/js/bootstrap.min.js"></script>
 ...
 <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/2.14.1/moment.min.js"></script> 
	...
	$(document).ready(function()
	{
		...
		$("#dropzone").dropzone({
			url: "uploads.php?inf="+guid+"&rc="+document.getElementById("rc").value,
			addRemoveLinks: true,
			maxFileSize: 100000,
			...
			removedfile: function(file, serverFileName)
			{
				...
				$.ajax({
					type: "POST",
					url: "uploads.php?delete=true&rc="+document.getElementById("rc").value,
					data: "filename="+name,
...
<div class="container">
	...
	<p>
	  ...
	  <div class="panel panel-default users-content">
            <div class="panel-body"> <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["create"])) { ?> <a href="../legalizaciones/view/addEdit.php?op=<?php echo $_REQUEST['op']?>" class="glyphicon glyphicon-plus" ></a><?php }?>
              ...
              <input name="rc" type="hidden" id="rc" value="<?php echo $_REQUEST['id']; ?>">
            </div>
            <p>&nbsp;</p>
