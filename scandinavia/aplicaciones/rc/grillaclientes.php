        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-cliente.php", // json datasource
    ...
    <div class="col-12">
      <div class="table-responsive">
        <div class="panel panel-default users-content">         
            <div class="panel-heading">Clientes  <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["create"])) { ?><a href="view/addEditmodulos.php?op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-plus" ></a><?php } ?></div>
            <table id="lookup" class="table table-striped">  
	                                   <thead bgcolor="#eeeeee" align="center">
                                        ...
                                        <th class="text-center"> Crear Anticipos </th> 	  
                                       </tr>
                                      </thead>
                                        <tbody>
                                        </tbody>
