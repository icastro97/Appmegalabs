...
{    
 ...
 $db_host="localhost";
    ...
    $stmt = $conn->prepare( "INSERT INTO condicioncomercial (descripcion, porcentaje, dias) VALUES (?, ?, ?)");
    $stmt->bindParam( 1, $descripcion);
    $stmt->bindParam( 2, $porcentaje);
...
<table width="50%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td colspan="4" align="center"><br>
      Maestro de Condiciones Comerciales<br>
      <br></td>
    </tr>
  <tr>
