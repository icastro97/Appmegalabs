...
{    
 ...
 $db_host="localhost";
    ...
    $stmt = $conn->prepare( "INSERT INTO tipopago (tipopago, banco, cuenta) VALUES (?, ?, ?)");
    $stmt->bindParam( 1, $tipopago);
    $stmt->bindParam( 2, $banco); 				
    $stmt->bindParam( 3, $cuenta); 					
	$i= 0;
