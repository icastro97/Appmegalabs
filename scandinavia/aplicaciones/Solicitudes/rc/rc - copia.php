...
No</td>
                ...
                <tr>
                  ...
                  <td width="32%"><input name="valoranticipo" type="text" id="valoranticipo" autocomplete="off" onkeyup="checkDecimals(this.form.valordescuentofinanciero, this.form.valoranticipo.value);" onchange="habilitaradi(this.value,<?=count($users)?> );" value="" placeholder="Porcentaje Adicional" size="20" class="form-control mb-2 mr-sm-2 mb-sm-0"/></td>
                </tr>
                <tr>
        ...
        No  
         <input type="hidden" name="valdocumentoanticipo" id="valdocumentoanticipo"></td>
                ...
                <tr>
                  ...
                  <td colspan="2"><select name="legalizaanticipo" id="legalizaanticipo" onchange="ShowSelected();" size="8" class="form-control form-control-lg">
                    <?php 
            ...
            <table cellpadding="0" cellspacing="0" class="table table-sm">  <!--class="table table-condensed"-->
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td align="right">$
                          <?=number_format($user['Valor_original'], 0,".",",") ?>
                        </td>
                        ...
                        <td><input name="Neto[]" type="text"   class="form-control mb-2 mr-sm-2 mb-sm-0" id="Neto<?=$count;?>" onClick="calculolinea(this.value,<?=count($users)?> );" required="required"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td><input type="hidden" name="valtotcalc" id="valtotcalc" />
