      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Maestro de Ficheros de Cartera</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          		<p>&nbsp;</p>
          		<section id="unseen">
            ...
            <table class="table table-striped">
                ...
                <tbody id="userData">
                    ...
                    <tr>
                        ...
                        <td> 
                        <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["create"]) && $user['estado'] == 0){ ?>
                            <a href="procesar.php?id=<?php echo $user['id']; ?>&op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-edit"></a>   
                           
                        <?php } else { echo "Fichero Procesado"; }
						?>                        
                         
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr><td colspan="5">Ficheros No encontrados......</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
       </div>
...
<script type="text/javascript">
    $(".remove").click(function(){
        var id = 1; //$(this).parents("tr").attr("id");


        if(confirm('Are you sure to remove this record ?'))
        {
            $.ajax({
               url: 'procesarfichero2.php',
               type: 'GET',
               data: {id: id},
               error: function() {
