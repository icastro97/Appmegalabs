...
<html lang="en">
        ...
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
				 ...
				 "language":	{
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-grid-anticipo.php", // json datasource
  ...
  <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Documentos por Anticipo</h3>
          	<div class="row mt">
          		<div class="col-lg-12">          		
          		<section id="unseen">
    ...
    <div class="col-12">
      <div class="table-responsive">
        <div class="panel panel-default users-content">         
            <div class="panel-heading">Documentos por Anticipo  <?php if (authorize($_SESSION["access"][$moduloconsulto][$modulecodigo]["create"])) { ?><a href="/scandinavia/aplicaciones/rc/ranticipo.php?op=<?php echo $_REQUEST['op'];?>" class="glyphicon glyphicon-plus" ></a><?php } ?></div>
