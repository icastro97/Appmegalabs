...
if(isset($_POST['adjunto']))
{
    ...
    require_once('funcionesEmpleados.php');
           ...
           if(file_exists($archivoGuardado))
            {
                            ...
                            while ($datos = fgetcsv($fp,0,";"))
                            {
                                        ...
                                        if($rows >1)
                                        {
                                            ...
                                            $resultado = insertarDatos($datos[0],$datos[1],$datos[2],$datos[3],$datos[4],$datos[5],$datos[6], $datos[7], $datos[8],$datos[9]);
        ...
        <div class="row" id="row">
            <div class="col-6 col-md-4"></div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="panel-heading text-center form-control"  id="panel" >Importador Clientes</div>
                        </div>
                        <div class="formulario" >
                            ...
                            <input type="hidden" name="ruta" value="Importador/usuarios/" readonly="readonly">
