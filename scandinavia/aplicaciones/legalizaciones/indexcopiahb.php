   ...
   <form id="my-form" method="post"  name="insertregistro" enctype="multipart/form-data">
	...
	<table width="100%" border="0">
	  ...
	  <tr>
	    ...
	    <td >
             ...
             <span class="input-group-addon">$</span>                                                                    
              <input id="ValorAnticipo" name="ValorAnticipo" class="form-control currency" disabled="disabled" required="required" type="text"/>
	  ...
	  <tr>
	    ...
	    <td width="13%" ><input name="identificacion"  onKeyUp="empleado(1)"  onBlur="empleado2(1)" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="identificacion"  placeholder="Identificacion"/></td>
...
<input name="input" id="buttonsave" type="submit" class="btn btn-primary" value="Enviar Información" /> 
