...
//detalle recibo
$conditionsdetalle['where'] = array('id'=> $parametro, 'recibido' => 1); 
...
$limpiacargo10 = eliminar_tildes($cabeza[0]['observacionP']);
...
.panel > .panel-heading {
 ...
 <!-- **********************************************************************************************************************************************************
   ...
   <a href="https://appmegalabs.com/scandinavia/aplicaciones/legalizaciones/listadolegalizacionesg.php?op=CONTABILIDAD" class="glyphicon glyphicon-circle-arrow-left" ></a> Regresar 
         <br>
         <br>
            ...
            <tbody id="userData2">
              ...
              <td>&nbsp;</td>
                ...
                ?></td>                
                   ...
                   <td align="center"><input type="checkbox" value="<?=$user['identificador']?>" name="recibido[]"></td>  
...
?>            
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
             <?php if($cabeza[0]['estado'] == '0'){?>
             
               <?php } else 
			   { 		
			       

               if($cabeza[0]['estado'] <> '0' ){ ?> 
            </div>
            <center>
            <h4 align="center"><br> <?=$limpiacargo10?>  </h4>
            <input type="submit" class="btn" style="background:#00AB84; color:white;" value="Procesar ">
            </center>
            <div align="center">
              <?php }
