   ...
   <form id="my-form" method="post"  name="insertregistro" enctype="multipart/form-data">
	...
	<table width="100%" border="0">
	  ...
	  <tr>
	    ...
	    <td align="center" valign="top"><input name="tipolegalizacion" type="text" disabled="disabled" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="tipolegalizacion" value="<?php echo $users[0]['tipolegalizacion']; ?>" readonly="readonly"/></td>
	    </tr>
	  <tr>
	    <td >&nbsp;</td>
	    <td >&nbsp;</td>
	  ...
	  <tr>
	    ...
	    <td ><input name="ValorAnticipo" type="number" disabled="disabled" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="ValorAnticipo" value="<?php echo $users[0]['valoranticipo']; ?>" readonly="readonly"/> </td>
	    </tr>
	  <tr>
	    <td >&nbsp;</td>
	    <td >&nbsp;</td>
	  ...
	  <tr>
	    <td width="12%" ><input name="fechamos" type='text' required class="form-control" id="fechamos" placeholder="Fecha" min="" value = "<?php echo $users[0]['fecha']; ?>" readonly="readonly"/>
                       <input name="fecha" id="fecha" type="hidden" value="<?php echo $users[0]['fecha']; ?>" />
                </td>
	    <td width="13%" ><input name="identificacion" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="identificacion"  placeholder="Identificacion"   value="<?php echo $users[0]['identificacion']; ?>" readonly="readonly"/></td>
	    <td width="21%" ><input name="nombre" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="nombre"  placeholder="Nombres" value="<?php echo $users[0]['nombre']; ?>" readonly="readonly"/></td>
	    <td width="13%" ><input name="cargo" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="cargo"  placeholder="Cargo" value="<?php echo $users[0]['cargo']; ?>" readonly="readonly"/></td>
	    <td width="9%" ><input name="ctocto" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="ctocto"  value="<?php echo $users[0]['ctocto']; ?>" readonly="readonly"/></td>
	    <td width="13%" ><input name="Linea" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="Linea"  placeholder="Linea" value="<?php echo $users[0]['linea']; ?>" readonly="readonly"/>
	      
	    </td>
	    <td width="19%" >
        <input name="Area" type="text" required="required" class="form-control mb-2 mr-sm-2 mb-sm-0" id="Area" value="<?php echo $users[0]['area']; ?>" placeholder="Area" readonly="readonly"/>        
        </td>
	    </tr>
	  <tr>
	    <td colspan="7" ><br />
<div class="col-xs-10">
                  ...
                  <div class="input-group">
                    <textarea name="txtobservaciones" rows="3" readonly="readonly" class="form-control mb-2 mr-sm-2 mb-sm-0" id="txtobservaciones" placeholder="Observaciones" onclick="operaciones();"><?php echo $users[0]['observaciones']; ?></textarea>
                  </div></div> 
 </td>
	    </tr>
	  <tr>
                  ...
                  <td><div class="col-xs-5">
                   ...
                   <div class="col-xs-3">
                                  ...
                                  <div class="input-group">
                                   ...
                                   <input id="valor1" name="valor[]" class="form-control currency" onChange="operaciones();" type="text"/>
...
<input name="input" type="submit" class="btn btn-primary" value="Enviar Información" />
            ...
            <tbody id="userData2">
              ...
              <tr>
  <td colspan="7"><a class="btn btn-success" href="finalizadoc.php?op=LISTADO LEGALIZACIONES&amp;documento=<?=$user['id']?>" role="button">Finalizar Documento</a></td>
  </tr>
