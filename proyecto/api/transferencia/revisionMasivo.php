...
$sql = "UPDATE transferencia_val SET tipoApr = 'REVC', observacionRevision = '$obser' , ultimoCambioEstado = NOW() WHERE id_transferencia = '$id'";
//var_dump($sql);
$query = mysqli_query($con, $sql);

   
     $consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$id','$user','REVC',NOW(),'$obser')";
     //var_dump($consulta);
