...
$sql = "UPDATE transferencia_val SET tipoApr = 'ENVC', observacionRevision = '$obser' , ultimoCambioEstado = NOW() WHERE id_transferencia = '$id'";
$query = mysqli_query($con, $sql);

   $consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$row[id]','$user','ENVC',NOW(),'$obser')";
  // echo $consulta;
