...
$products = [];
$sql = "SELECT id_transferencia,tipoFactura, radicado, factura, fecFact, establecimiento, descripcion, estado as estado, recibido FROM transferencia_val where estado in ('POR PAGAR')";
