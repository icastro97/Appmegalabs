...
$sql = "UPDATE transferencia_val SET estado  = 'APR', tipoApr = NULL,  observacionRevision = '$obser' , ultimoCambioEstado = NOW() WHERE id_transferencia = '$id'";
//var_dump($sql);
$query = mysqli_query($con, $sql);

   $consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$id','$user','APR',NOW(),'$obser')";
