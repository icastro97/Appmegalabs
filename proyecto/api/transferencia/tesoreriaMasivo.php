...
$sql = "UPDATE transferencia_val SET estado  = 'POR PAGAR', observacionRevision = '$obser' , ultimoCambioEstado = NOW() WHERE id_transferencia = '$id'";
$query = mysqli_query($con, $sql);

   $consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$id','$user','POR PAGAR',NOW(),'$obser')";
