...
header("Access-Control-Allow-Methods: PUT, GET, POST, DELETE");
 ...
 $obser = $_GET['obs'];
  ...
  $id = $row["id"];  
    ...
    $sql = "UPDATE transferencia_val SET estado  = 'PNC', observacionRevision = '$obser' , ultimoCambioEstado = NOW() WHERE id_transferencia = '$row[id]'";
    $query = mysqli_query($con, $sql);

   $consulta = "INSERT INTO `Historico_facturas`(`id_factura`, `usuario`, `nuevo_estado`, `fecha_cambio`,`Observacion`) VALUES ('$row[id]','$user','PNC',NOW(),'$obser')";
